...
\title{\mmocks: An emulated cosmological simulation suite for simulation-based inference}

\author{Kate Storey-Fisher, Marcos Pellejero-Ibanez, Ra\'ul Angulo, \& friends \ksf{order?}}
...
Before training, we reparameterize the cosmology and bias parameters to combinations that are better constrained by the summary statistics, and thus should result in improved training convergence \cite{XXX (ask bea)}.
