...
% comments
\newcommand{\ksf}[1]{{\color{teal}{ksf: #1}}}
...
Kate Storey-Fisher,$^{1}$\thanks{E-mail: kate.storey-fisher@dipc.org}
Marcos Pellejero-Iba\~nez,$^{1}$
Ra\'ul Angulo,$^{1}$
and others \ksf{order? affiliations?}
\\
$^{1}$Donostia International Physics Center, Paseo Manuel de Lardizabal 4, 20018 Donostia-San Sebastian, Spain
}
...
The authors would like to thank Jed (LMU), Beatriz Tucci, Matt Ho; Matteo Zennaro, Daniel L\'opez-Cano, Francisco Maion and the rest of the \bacco group; and Risa Wechsler and the KIPAC Galaxy Formation and Cosmology group for helpful discussions.
